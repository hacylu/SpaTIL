...
feat = [mean(featAreaRatio), std(featAreaRatio), var(featAreaRatio), min(featAreaRatio), max(featAreaRatio), max(featAreaRatio)-min(featAreaRatio),...
    nanmean(featDensityRatio), nanstd(featDensityRatio), nanvar(featDensityRatio), min(featDensityRatio), max(featDensityRatio), max(featDensityRatio)-min(featDensityRatio)];
